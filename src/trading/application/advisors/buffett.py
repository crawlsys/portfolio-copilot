"""Warren Buffett advisor — the first persona analyst.

A stylized approximation of Buffett's public investment philosophy (not the
actual individual, not an endorsement). The persona is ONLY a system prompt —
all machinery lives in AdvisorAgent; all data comes from the point-in-time
FundamentalsSnapshot. Prompt ported verbatim from ai-hedge-fund v2 (MIT).
"""
...
class BuffettAdvisor(AdvisorAgent):
